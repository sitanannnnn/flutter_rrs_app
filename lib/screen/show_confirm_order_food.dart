...
class ShowConfirmedOrderFood extends StatefulWidget {
  ShowConfirmedOrderFood({
    Key? key,
  }) : super(key: key);
  @override
  _ShowConfirmedOrderFoodState createState() => _ShowConfirmedOrderFoodState();
}

class _ShowConfirmedOrderFoodState extends State<ShowConfirmedOrderFood> {
...
//อ่านค่ารยการอาหารที่เราสั่งจากฐานข้อมูล
  Future<Null> readOrderfood() async {
    ...
    String url =
        '${Myconstant().domain}/my_login_rrs/getOrderfoodWherecustomerIdAndConfirmedOrderfoodStatus.php?isAdd=true&customerId=$customerId&reservationId=$reservationId&orderfoodStatus=$orderfoodStatus';
