...
//อ่านค่ารยการอาหารที่เราสั่งจากฐานข้อมูล
  Future<Null> readOrderfood() async {
    ...
    print('test =>$reservationId');
    String url =
        '${Myconstant().domain_00webhost}/getOrderfoodWherecustomerIdAndConfirmOrderfoodStatus.php?isAdd=true&customerId=$customerId';
    Response response = await Dio().get(url);
    if (response.statusCode == 200) {
      // print('res==> $response');
      var result = json.decode(response.data);
      print('result confirm= $result');
